...
public:
    WebotControl() : rate(10) {
        ...
        obstacle_left_sub = nh.subscribe<sensor_msgs::PointCloud2>("/filter_L", 10, &WebotControl::obstacleLeftCallback, this);
        obstacle_right_sub = nh.subscribe<sensor_msgs::PointCloud2>("/filter_R", 10, &WebotControl::obstacleRightCallback, this);
    }
...
private:
    ...
    ros::Publisher steering_pub;
    ros::Subscriber obstacle_left_sub;
    ros::Subscriber obstacle_right_sub;
    ros::Rate rate;
};
