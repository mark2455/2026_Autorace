...
void calculateVelocity() {
    ...
    if (!is_kdtree_initialized) {
        ...
        kdtree->setInputCloud(combinedCloud.makeShared());
    ...
    for (int i = 0; i < pointIdxRadiusSearch.size(); ++i) {
        filteredCloud.points.push_back(combinedCloud.points[pointIdxRadiusSearch[i]]);
    }
