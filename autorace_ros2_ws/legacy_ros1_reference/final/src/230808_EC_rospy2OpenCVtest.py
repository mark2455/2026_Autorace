...
class Webot_control:
    ...
    def comp_img_CB(self,msg):
        ...
        self.comp_img = self.cv2.imread('/home/wego/Downloads/roibrightday.png', cv2.IMREAD_COLOR)
        os.system("clear") 
        # <이미지 필수 전처리 과정 end>
        ...
        img_hsv =cv2.cvtColor(self.comp_img,cv2.COLOR_BGR2HSV)   #잘림 1:57:14 지점에 나옴
