...
def detect_white_lane_fillter_package(img):        ###########!!(Trial)
    hsv = img   #=========================================== img가 아닌 image로 해야지 않나? img 선언필요
...
def start():
    ...
    image = rospy.Subscriber("/usb_cam/image_rect/compressed",CompressedImage,img_callback)
    ...
    while not 921600 == (WIDTH * HEIGHT * 3):                          #=========================================
        continue
